...
def milling_features(df, n_chunks, chunk_index, n_jobs, feature_dictionary=comprehensive_features):
...
def main(args):
    ...
    elif args.dataset == "milling":
        df_feat = milling_features(df, n_chunks, chunk_index, n_jobs=args.n_cores, feature_dictionary=feat_dict)
    else:
        print("Dataset not recognized. Please use 'cnc' or 'milling'.")
        return
